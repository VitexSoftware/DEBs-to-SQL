...
**Purpose**: SQL Database of debian packages and its contents indexer
**Status**: Active
**Repository**: git@github.com:VitexSoftware/DEBs-to-SQL.git
...
git clone git@github.com:VitexSoftware/DEBs-to-SQL.git
cd DEBs-to-SQL
