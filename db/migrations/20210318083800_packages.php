...
final class Packages extends AbstractMigration {
    ...
    public function change(): void {
        ...
        $table->addColumn('Name', 'string', ['null' => false])
                ->addColumn('Package', 'string', ['null' => false])
                ->addColumn('Appname', 'string', ['null' => false])
                ->addColumn('Essential', 'string', ['null' => false])
                ->addColumn('Vendor', 'string', ['null' => false])
                ->addColumn('License', 'string', ['null' => false])
                ...
                ->addColumn('Depends', 'text', ['null' => true])
